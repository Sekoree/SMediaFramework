...
{
    // ---- transport ----
    public static StreamGeometry Play => _play ??= G("M6,4 L20,12 L6,20 Z");
    public static StreamGeometry Pause => _pause ??= G("M5,4 H10 V20 H5 Z M14,4 H19 V20 H14 Z");
    public static StreamGeometry Stop => _stop ??= G("M5,5 H19 V19 H5 Z");
    public static StreamGeometry Previous => _previous ??= G("M5,4 H8 V11 L20,4 V20 L8,13 V20 H5 Z");
    public static StreamGeometry Next => _next ??= G("M16,4 H19 V20 H16 V13 L4,20 V4 L16,11 Z");
    ...
    public static StreamGeometry SwapArrows => _swapArrows ??= G(
        "M4,7.2 H14 V4.6 L20.5,8.4 L14,12.2 V9.6 H4 Z " +
        "M20,16.8 H10 V19.4 L3.5,15.6 L10,11.8 V14.4 H20 Z");
    public static StreamGeometry Folder => _folder ??= G("M2,5 H9.5 L11.5,7.5 H22 V19 H2 Z");

    // ---- actions ----
    public static StreamGeometry Gear => _gear ??= G(
    ...
    public static StreamGeometry Close => _close ??= G(
        "M5,6.4 L6.4,5 L12,10.6 L17.6,5 L19,6.4 L13.4,12 L19,17.6 L17.6,19 L12,13.4 L6.4,19 L5,17.6 L10.6,12 Z");
    public static StreamGeometry Plus => _plus ??= G("M10,4 H14 V10 H20 V14 H14 V20 H10 V14 H4 V10 H10 Z");
    public static StreamGeometry ArrowUp => _arrowUp ??= G("M12,4 L20,12 H15 V20 H9 V12 H4 Z");
    public static StreamGeometry ArrowDown => _arrowDown ??= G("M12,20 L4,12 H9 V4 H15 V12 H20 Z");
    public static StreamGeometry Refresh => _refresh ??= G(
        "M12,3 L18,7.5 L12,12 V9 A5,5 0 1 0 17,14 H20 A8,8 0 1 1 12,6 Z");
    public static StreamGeometry Loop => _loop ??= G(
        "M7,6.8 H16 V4.2 L21.5,8 L16,11.8 V9.2 H9.4 V12 H7 Z " +
        "M17,17.2 H8 V19.8 L2.5,16 L8,12.2 V14.8 H14.6 V12 H17 Z");
    public static StreamGeometry Shuffle => _shuffle ??= G(
    ...
    public static StreamGeometry Pin => _pin ??= G(
    ...
    public static StreamGeometry Duplicate => _duplicate ??= G(
        "M8,2 H22 V16 H18 V13.6 H19.6 V4.4 H10.4 V6 H8 Z M2,8 H16 V22 H2 Z M4.4,10.4 V19.6 H13.6 V10.4 Z");
    public static StreamGeometry Edit => _edit ??= G(
        "M3,17.2 L14.9,5.3 L18.7,9.1 L6.8,21 H3 Z M16.3,3.9 L18.2,2 L22,5.8 L20.1,7.7 Z");
    public static StreamGeometry Eject => _eject ??= G("M12,4 L20,13 H4 Z M4,15.5 H20 V18.5 H4 Z");
    public static StreamGeometry Lock => _lock ??= G(
    ...
    // ---- media kinds ----
    public static StreamGeometry Image => _image ??= G(
    ...
    public static StreamGeometry Speech => _speech ??= G("M3,4 H21 V16 H12 L7,21 V16 H3 Z");
    public static StreamGeometry TextCard => _textCard ??= G(
        "M3,4 H21 V20 H3 Z M5,6 V18 H19 V6 Z M7,8.2 H17 V10 H7 Z M7,11.8 H14 V13.6 H7 Z");
    public static StreamGeometry Person => _person ??= G(
        "M12,3 A3.4,3.4 0 1 0 12,9.8 A3.4,3.4 0 1 0 12,3 Z M4.8,21 A7.2,7.2 0 0 1 19.2,21 Z");
    public static StreamGeometry VideoClip => _videoClip ??= G("M3,5 H21 V19 H3 Z M9.8,8.6 L16,12 L9.8,15.4 Z");
    public static StreamGeometry Antenna => _antenna ??= G(
    ...
    public static StreamGeometry Microphone => _microphone ??= G(
    ...
    private static StreamGeometry? _arrowDown;
    private static StreamGeometry? _arrowUp;
    ...
    private static StreamGeometry? _folder;
    private static StreamGeometry? _gear;
    private static StreamGeometry? _grid;
    private static StreamGeometry? _image;
    private static StreamGeometry? _info;
    private static StreamGeometry? _lock;
    private static StreamGeometry? _loop;
    private static StreamGeometry? _menu;
    private static StreamGeometry? _microphone;
    private static StreamGeometry? _next;
    private static StreamGeometry? _pause;
    private static StreamGeometry? _person;
    private static StreamGeometry? _pin;
    private static StreamGeometry? _play;
    private static StreamGeometry? _plus;
    private static StreamGeometry? _previous;
    private static StreamGeometry? _refresh;
    private static StreamGeometry? _shuffle;
    private static StreamGeometry? _sliders;
    private static StreamGeometry? _speech;
    private static StreamGeometry? _stop;
    private static StreamGeometry? _swapArrows;
    private static StreamGeometry? _textCard;
    private static StreamGeometry? _videoClip;
    private static StreamGeometry? _warning;
}
