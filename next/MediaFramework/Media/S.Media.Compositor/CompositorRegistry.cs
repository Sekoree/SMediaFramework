...
public interface ICompositorRegistry
{
    ...
    /// <summary>Creates a new layer surface for <paramref name="kind"/>, or <c>false</c> if none registered.</summary>
...
{
    private readonly Dictionary<string, Func<IVideoCompositorLayerSurface>> _surfaces =
...
internal sealed class CompositorRegistry : ICompositorRegistry
{
    ...
    public CompositorRegistry(Dictionary<string, Func<IVideoCompositorLayerSurface>> surfaces) =>
        _surfaces = new Dictionary<string, Func<IVideoCompositorLayerSurface>>(surfaces, StringComparer.OrdinalIgnoreCase);
