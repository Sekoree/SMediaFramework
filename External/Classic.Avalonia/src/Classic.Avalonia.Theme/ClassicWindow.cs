...
public class ClassicWindow : Window
{
    ...
    // Avalonia 12 removed the ExtendClientAreaToDecorationsChanged override point; applying the
    // corner fix when the window opens covers the same situations (the hint is set before opening).
