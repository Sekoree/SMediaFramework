...
For framework-wide playback naming (`MediaContainerSession`, `MediaContainerPlaybackBundle`, `PortAudioPlaybackHost`), see the 2026-05 framework review §1.3 and checklist Phase 1 (archived).
