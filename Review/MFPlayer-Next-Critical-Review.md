...
- **NXT-14 (remainder)** — the broader adversarial/sync/perf/cutover test build-out beyond the targeted regressions added so far (much of it depends on the deferred gates' behavior existing first).
