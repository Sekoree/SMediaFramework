...
/// <c>CompositorLayer</c> by value.
/// </para>
/// <para>
/// CPU compositor (<c>CpuVideoCompositor</c>) supports any non-degenerate affine via
    ...
    float M21, float M22, float Ty)
{
    ...
    /// an axis). Used by <c>CpuVideoCompositor</c> for inverse sampling.
    /// </summary>
