...
/// one <see cref="CompositorLayer"/>), so this stage runs in the vertex domain - deliberately
/// distinct from the fragment-domain color stage (<see cref="Core.Video.Effects.VideoLayerEffect"/>),
