...
{
    /// <summary><see cref="S.Media.FFmpeg.MediaContainerMegaPlaybackHost"/> disposes the decoder (default for path-based <see cref="MediaPlayer.TryOpen(string,...)"/>).</summary>
