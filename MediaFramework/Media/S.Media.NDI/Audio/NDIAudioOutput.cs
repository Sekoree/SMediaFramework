...
/// <summary>
/// <see cref="IAudioOutput"/> backed by an <see cref="NDIOutput"/>'s shared
...
internal sealed unsafe class NDIAudioOutput : IAudioOutput, IAudioOutputChannelCapabilities, IDisposable
{
    ...
    internal NDIAudioOutput(NDISender sender, AudioFormat format, NDIEgressPresentationTimeline? presentationTimeline = null)
    {
    ...
    public void Dispose()
    {
        ...
        {
            MediaDiagnostics.SwallowDisposeErrors(() => NativeMemory.Free(_packedBuffer), "NDIAudioOutput.Dispose: packed buffer");
            _packedBuffer = null;
