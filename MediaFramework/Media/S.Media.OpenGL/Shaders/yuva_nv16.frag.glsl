...
// Semi-planar 16-bit YUV with alpha: Y in plane 0 (R16), interleaved UV in
// plane 1 (RG16), alpha in plane 2 (R16). Used for NDI PA16-style frames.
...
void main()
{
    ...
    rgb = gamutMatrix * rgb;
    float a = clamp(textureBicubicR(aPlane, v_uv, uTexBicubicDim2) * bitScale, 0.0, 1.0);
