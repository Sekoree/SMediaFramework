...
public static class MediaFrameworkRuntimeSdl3Extensions
{
    /// <summary>
    /// Registers the SDL3 hidden-window OpenGL compositor as the process-wide
    /// <see cref="VideoCompositorBackend.Auto"/> GPU backend.
    /// </summary>
    public static MediaFrameworkRuntimeBuilder UseSDL3OpenGLCompositor(this MediaFrameworkRuntimeBuilder builder)
    {
        ArgumentNullException.ThrowIfNull(builder);
        var registration = VideoCompositor.RegisterAutoBackend(SDL3GLVideoCompositor.TryCreate);
        MediaFrameworkRuntime.RegisterShutdown(registration.Dispose);
        return builder;
    }
}
