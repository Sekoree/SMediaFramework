...
public sealed class ClipAudioOutputRuntime : IDisposable
{
        ...
        string? displayName = null)
    {
        ...
        try
        {
            ...
            // Genlock actuation (the AdaptiveRateAudioOutput device-rate-slew wrapper) is a non-master-output
            // feature that returns with the Phase-5 adaptive-rate output; the shared output wires plainly here.
