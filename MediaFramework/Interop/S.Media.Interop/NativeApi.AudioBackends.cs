...
/// devices, and create an output on any backend by name. This is what makes the C ABI ready for additional
/// audio backends (e.g. miniaudio) without new per-backend entry points — a host passes the backend name
/// (null/empty = the default backend) and an opaque device id from the enumeration.
/// </summary>
